...
import sabaagh_saad_alabdullah from "@/app/Images/links-images/aisbgh_alkuayt.webp"

import sabaagh_aljahraa from "@/app/Images/links-images/aisbgh_alkuayt.webp"
import sabaagh_abdullah_mubarak from "@/app/Images/links-images/aisbgh_alkuayt.webp"
import sabaagh_gharb_abdullah from "@/app/Images/links-images/aisbgh_alkuayt.webp"
import sabaagh_janoub_abdullah from "@/app/Images/links-images/aisbgh_alkuayt.webp"
import sabaagh_alaardiya from "@/app/Images/links-images/aisbgh_alkuayt.webp"
import sabaagh_alfardus from "@/app/Images/links-images/aisbgh_alkuayt.webp"
import sabaagh_subah_alanasir from "@/app/Images/links-images/aisbgh_alkuayt.webp"
import sabaagh_alromanisya from "@/app/Images/links-images/aisbgh_alkuayt.webp"
...
const linksData: { [key: string]: React.ReactNode } = {
    ...
    sabaagh_shatir: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ شاطر - صباغ ممتاز - <b>صباغ الكويت</b> - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
                <b>صباغ الكويت</b> يوفر لكم كل هذه الاشياء في عمله فان خبرته تجعله افضل صباغ حيث انه يعمل بأفضل الخامات عليه الجودة الذي تجعل عمليه الدهان تتم على اكمل وجه كما يتميز بانه يمتلك فريق عمل متخصص ويجعله يتمم المهمة في اسرع وقت كما يتميز <b>صباغ الكويت</b> بانه يوفر لكم ارخص الاسعار داخل دولة الكويت ويتبع الطرق الحديثة في عمليات الدهان ودائما ما يسعى لتطوير الخدمات التي يقدمها من اجل ارضاء العملاء
            </Typography>
    ...
    muealim_sabaagh_bi_alkuayt: (
        <Stack alignItems="center" spacing={2}>
            <Stack spacing={2} alignItems="center">
                <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                    معلم صباغ محترف لخدمات الطلاء المنزلي - 50713199
                </Typography>
                <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    faniy_sabagh: (
        <Stack alignItems="center" spacing={2}>
            <Stack spacing={2} alignItems="center">
                <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                    فني صباغ - <b>صباغ الكويت</b> - 50713199
                </Typography>
                <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    sabaagh_mumtaz_bi_alkuayt: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ ممتاز الكويت - خدمات دهان احترافية - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    dikurat_sabagh_lilkuayt: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                ديكورات الكويت - صباغ ديكورات - صباغ ممتاز ديكورات - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    shaqaq_sabaagh_bi_alkuayt: (
        <Stack alignItems="center" spacing={2}>
            ...
            /> */}
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ شقق بالكويت - صباغ شقق - صباغ شقق شاطر بالكويت - صباغ شقق ممتاز بالكويت - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    sabaagh_rusumat_aitfal: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ رسومات اطفال صباغ ممتاز رسومات اطفال - صباغ شاطر رسومات اطفال - صباغ فني رسومات اطفال - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    sabaagh_rakhisat_bi_alkuayt: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ رخيص بالكويت - صباغ بالكويت رخيص - اصباغ رخيصة - فني صباغ رخيص - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    dihanat_alkuayt: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ فني دهانات - فني دهانات بالكويت - صباغ فني بالكويت - افضل فني صباغ دهانات بالكويت - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    tarkib_waraq_judran: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                تركيب ورق جدران - فني تركيب ورق جدران - معلم تركيب ورق جدران في الكويت - ورق جدران الكويت - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    asbagh_abwab_khashabia: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ ابواب خشب - صباغ ابواب خشب في الكويت - صباغ ممتاز ابواب خشب - صباغ فني ابواب خشب في الكويت - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
    ...
    muealim_jabs_burd: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                معلم جبس بورد الكويت - جبس بورد -فني جبس بورد - جبس بورد الكويت - 50713199
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
...
const de = {
    ...
    sabaagh_saad_alabdullah: <ImageStyle src={sabaagh_saad_alabdullah} alt={"صباغ سعد العبدالله"} />,
    sabaagh_aljahraa: <ImageStyle src={sabaagh_aljahraa} alt={"صباغ الجهراء"} />,
    sabaagh_abdullah_mubarak: <ImageStyle src={sabaagh_abdullah_mubarak} alt={"صباغ العبدالله مبارك"} />,
    sabaagh_gharb_abdullah: <ImageStyle src={sabaagh_gharb_abdullah} alt={"صباغ غرب عبدالله"} />,
    sabaagh_janoub_abdullah: <ImageStyle src={sabaagh_janoub_abdullah} alt={"صباغ جنوب عبدالله"} />,
    sabaagh_alaardiya: <ImageStyle src={sabaagh_alaardiya} alt={"صباغ العارضية"} />,
    sabaagh_alfardus: <ImageStyle src={sabaagh_alfardus} alt={"صباغ الفردوس"} />,
    sabaagh_subah_alnasir: <ImageStyle src={sabaagh_subah_alanasir} alt={"صباغ صباح الناصر"} />,
    sabaagh_alromanisya: <ImageStyle src={sabaagh_alromanisya} alt={"صباغ الرومانسية"} />
}
