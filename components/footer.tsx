                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-6xl mx-auto">
                        ...
                        <p className="text-lg leading-relaxed">
                            نقدم خدمات بمنتهى الاحترافية والدقة بدون أي خلل حيث أنه يقوم صباغ الكويت بتقديم كافة الخدمات التي تخص
                            أحدث الطلعات والتشطيبات على أعلى مستوى، يتم إنجاز جميع المهام في وقت قياسي حيث أن صباغ شاطر بالكويت يحرص
                            على تقديم خدمات أصباغ تتناسب مع مختلف العملاء الكرام، يتم تركيب جميع أنواع الأرضيات، حيث أن صباغ الكويت
                            يقدم لكم باقات متنوعة من الخدمات التي تعتبر مفهوم للجميع.
                        </p>
                    </div>
                </div>
            </div>}
