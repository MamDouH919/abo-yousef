                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-lg mb-6">
                            <b>صباغ الكويت</b> يقدم مجموعة واسعة من الأصباغ الحديثة، بما في ذلك الأصباغ الداخلية والخارجية، الصبغ المطفي واللماع، بالإضافة إلى الصبغ بدون رائحة والصبغ الإيطالي المميز.
                        </p>
